...
void FloatAttribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
...
void IntAttribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
...
void Vec2Attribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
...
void Vec3Attribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
...
void Vec4Attribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
...
void Mat2Attribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
...
void Mat3Attribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
...
void Mat4Attribute::exportAsUniform(const Shader& shader) const
{
	shader.activate();
